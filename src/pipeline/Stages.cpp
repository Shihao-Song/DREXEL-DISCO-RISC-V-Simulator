...
void IF_Stage::tick()
{
    ...
    if (stall == 0)
    {
        ...
        */
        ...
        if (DEBUG)
        {
            std::cout << "IF : " << instr->raw_instr << " | ";	
        }
    }
}

void ID_Stage::hazardDetection()
{
    /*
